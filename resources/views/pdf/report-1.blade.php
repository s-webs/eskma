...
<style type="text/css" media="all">
    ...
    * {
    ...
    .table_head_item3, .table_body_item3 {
        float: left;
        width: 20%;
        text-align: center;
        ...
        <div class="table_head">
            <div class="table_head_list clearfix">
                ...
                <div class="table_head_item2 t-center">
                    Перечень работ, подлежащих выполнению (изучению) в соответствии с рабочей программой
    ...
    <div class="table_body">
        @foreach ($practice->plan as $plan)
            <div class="table_body_list clearfix">
                ...
                <div class="table_body_item2">{!! $plan->content !!}</div>
                <div class="table_body_item3">{{ $plan->start }} - {{ $plan->end }}</div>
            </div>
        @endforeach
    </div>
</div>
